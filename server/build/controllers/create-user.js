...
function makeCreateUserController(_a) {
    var createUser = _a.createUser;
    return function createUserController(httpRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var data, response, user, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, createUser({ payload: data.info })];
                    case 2:
                        user = _a.sent();
                        return [2 /*return*/, {
                                headers: { "Content-Type": "application/json", },
...
exports.default = makeCreateUserController;
