...
function makeSendVertificationController() {
    return function sendVertificationController(httpRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var phone_number, response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        phone_number = lodash_1.default.get(httpRequest, 'context.validated.phone_number');
...
exports.default = makeSendVertificationController;
